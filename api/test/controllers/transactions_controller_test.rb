  ...
  test 'should create transaction' do
    assert_difference('Transaction.count') do
      post transactions_url,
           params: { transaction: { amount: @transaction.amount, coin_name: @transaction.coin_name, transaction_type: @transaction.transaction_type, user_id: @transaction.user_id } }, as: :json
    end
