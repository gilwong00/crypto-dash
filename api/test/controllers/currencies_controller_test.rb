...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference("Currency.count") do
      post currencies_url, params: { currency: { coin_name: @currency.coin_name, value: @currency.value } }, as: :json
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { coin_name: @currency.coin_name, value: @currency.value } }, as: :json
    assert_response :success
  end
